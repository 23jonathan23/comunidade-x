  ...
  <div class="article-admin">
    <b-form>
      ...
      <b-form-group v-if="mode === 'save'" label="Categoria:" label-for="article-categoryId">
        <b-form-select id="article-categoryId" v-model="article.categoryId" :options="categories"></b-form-select>
      </b-form-group>
      <b-form-group v-if="mode === 'save'" label="Autor:" label-for="article-userId">
        <b-form-select id="article-userId" v-model="article.userId" :options="users"></b-form-select>
      </b-form-group>
...
export default {
  ...
  methods: {
    ...
    save() {
      const method = this.articles.id ? "put" : "post";
